...
type UiLanguageSetting = "auto" | "en" | "ja" | "zh";
...
function readBundleFile(lang: Exclude<UiLanguageSetting, "auto">): L10nBundle | null {
  const fileName =
    lang === "ja" ? "bundle.l10n.ja.json" : lang === "zh" ? "bundle.l10n.zh.json" : "bundle.l10n.json";
